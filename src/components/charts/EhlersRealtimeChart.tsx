  ...
  return (
    <Card className="p-4 md:p-6 border-border bg-card">
      ...
      <Tabs value={selectedFilter} onValueChange={setSelectedFilter} className="w-full">
        ...
        <TabsContent value="all" className="h-[350px]">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={data}>
              ...
              <YAxis yAxisId="price" stroke="hsl(var(--muted-foreground))" tick={{ fontSize: 10 }} />
              <YAxis yAxisId="oscillator" orientation="right" stroke="hsl(var(--muted-foreground))" tick={{ fontSize: 10 }} />
              <Tooltip contentStyle={{ backgroundColor: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "8px" }} />
              <Legend />
              <Line yAxisId="price" type="monotone" dataKey="price" stroke="hsl(var(--foreground))" strokeWidth={2} dot={false} name="Price" />
              <Line yAxisId="price" type="monotone" dataKey="superSmoother" stroke="hsl(var(--primary))" strokeWidth={1.5} dot={false} name="Super Smoother" />
              <Line yAxisId="oscillator" type="monotone" dataKey="fisher" stroke="hsl(var(--accent))" strokeWidth={1.5} dot={false} name="Fisher Transform" />
            </ComposedChart>
          </ResponsiveContainer>
        </TabsContent>
        ...
        <TabsContent value="superSmoother" className="h-[350px]">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={data}>
              <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" opacity={0.3} />
              <XAxis dataKey="time" stroke="hsl(var(--muted-foreground))" tick={{ fontSize: 10 }} />
              ...
              <Tooltip contentStyle={{ backgroundColor: "hsl(var(--card))", border: "1px solid hsl(var(--border))", borderRadius: "8px" }} />
              <Legend />
              <Line type="monotone" dataKey="price" stroke="hsl(var(--muted-foreground))" strokeWidth={1} dot={false} name="Price" />
              <Line type="monotone" dataKey="superSmoother" stroke="hsl(var(--success))" strokeWidth={2} dot={false} name="Super Smoother" />
            </ComposedChart>
          </ResponsiveContainer>
        </TabsContent>
